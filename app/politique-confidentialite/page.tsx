const PolitiqueConfidentialite = () => {
  return (
    <div className="container mx-auto py-8">
      ...
      <p className="mb-2">
        La présente politique de confidentialité décrit la manière dont TeamUp!
      ...
      <h2 className="text-xl font-semibold mb-2">Collecte des Informations</h2>
      <p className="mb-2">
        ...
        <ul className="list-disc ml-6">
          ...
          <li>
            Informations relatives à votre utilisation de notre site web (pages
      ...
      <p className="mb-2">
        ...
        sauf si cela est nécessaire pour fournir nos services ou si la loi nous
        y oblige.
      </p>
